...
<html>
	...
	<style type="text/css">
        ...
        <script>
        require(['dijit/Dialog', 'dojox/grid/DataGrid', 'dojo/data/ItemFileWriteStore', 'dojo/dom', 'dojo/_base/xhr', 'dojo/on', 'dojo/domReady!'],
            function(Dialog, DataGrid, ItemFileWriteStore, dom, xhr, on){
                ...
                function postAdd(store) {
                    on(addButton,'click',
                        function(e){
                            var reqVal = {
                                    number: dom.byId("number").value,
                                    value: dom.byId("value").value,
                                    isActive: dom.byId("isActive").value
                                }
                            xhr.post({
                                url: "create.htm",
                                handleAs: "json",
